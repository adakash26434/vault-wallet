    ...
    <div className="space-y-7">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-0.5 text-[14px]">Track your income and expenses in Nepali Rupees.</p>
        </div>
        <FinanceFormDialog>
      ...
      <div className="flex items-center gap-3">
        ...
        {!isCurrentMonth && (
          <Button variant="outline" size="sm" className="h-7 text-[12px] ml-1"
